...
<head>
    ...
    <link rel="stylesheet" href="{{asset('')}}welcome/css/templatemo_misc.css">
    <link rel="stylesheet" href="{{asset('')}}welcome/css/templatemo_style.css">
    <!-- JavaScripts -->
    <script src="{{asset('')}}welcome/js/jquery-1.11.1.min.js"></script> <!-- lightbox -->
    <script src="{{asset('')}}welcome/js/templatemo_custom.js"></script> <!-- lightbox -->
    <script src="{{asset('')}}welcome/js/jquery.lightbox.js"></script>
    <script src="{{asset('')}}welcome/js/bootstrap-collapse.js"></script>
    <!-- JavaScripts -->
</head>
<body>
    <div id="templatemo_home" class="templatemo_headerimg"><img src="welcome/images/face.jpg" alt="templatemo header"></div>
    <div class="templatemo_headerimg_cover"><img src="welcome/images/templatemo_header.png" alt=""></div>
    <div class="templatemo_headerwrapper">
        <div class="templatemo_menu">
            ...
            <div class="templatemo_socialmedia">
                <div class="templatemo_social"><a href="#"><img src="welcome/images/facebook.png" alt="templatemo facebook"></a></div>
                <div class="templatemo_social"><a href="#"><img src="welcome/images/twitter.png" alt="templatemo twitter"></a></div>
                <div class="templatemo_social"><a href="#"><img src="welcome/images/googleplus.png" alt="templatemo googleplus"></a></div>
            </div>
        </div>
        <div class="clear"></div>
        <div class="container templatemo_wrapper">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="templatemo_title"><span>BIO</span>EXP</div>
                    <div class="templatemo_subtitle">MADAGASCAR</div>
                </div>
                <div class="col-sm-6 templatemo_home">
                    <div class="templatemo_headertitle">MORINGA</div>
                    <div class="clear"></div>
                    <div class="templatemmo_subheader">Moringa plante endémique du sud ouest de MADAGASCAR.</div>
                    <div class="clear"></div>
                    <div class="templatemo_hometext">
                        <p>Une puissance naturelle venue de Madagascar. Connu sous le nom d' "arbre aux miracles", le moringa oleifera est une plante subtropicale aux propriétés ... <a rel="nofollow" href="http://www.smashingmagazine.com/2012/11/20/art-professions-icons-png/">Art Professions</a> Icon and <a rel="nofollow" href="http://unsplash.com">Unsplash</a> for images used in this template.</p>
                        <p>Le moringa de son nom botanique moringa oleifera dérive du tamil murungai qui signifie gousse tordue en faisant référence au fruit de l'arbre. A Madagascar, l'arbre appelé ananambo est connu sous le nom d'arbre aux miracles. Ses feuilles très nutritives sont servies comme mets principal à consommer avec le riz
                        </p>

                        <div class="row">
                        <div class="col-md-6"></div>
                        <div class="col-md-6">
                            <div class="templatemo_morebutton"><a href="#">INSCRIPTION</a></div><br>
                            <div class="templatemo_morebutton"><a href="#">CONNEXION</a></div>
                        </div>
                        </div>
                    </div>
        ...
        <div id="templatemo_service" class="container">
            <div class="row">
                <div class="col-md-6 templatemo_service">
                    <div class="gallery-item">
                        <img src="welcome/images/service/1.jpg" alt="gallery 1">
                        <div class="templatemo_service_frame"><img src="welcome/images/templatemo_serviceimg.png" alt="templatemo_frame"></div>
                        <div class="overlay">
                            <div class="templatemo_service_frame"><img src="welcome/images/templatemo_serviceimg1.png" alt="templatemo_frame"></div>
                            <a href="welcome/images/service/1.jpg" data-rel="lightbox" class="fa fa-search-plus"></a>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 templatemo_service">
            ...
            <div class="row templatemo_ordering">
                ...
                <div class="col-md-6 templatemo_service two">
                    <div class="gallery-item">
                        <img src="welcome/images/service/2.jpg" alt="gallery 2">
                        <div class="templatemo_service_frame"><img src="welcome/images/templatemo_serviceimg.png" alt="templatemo_frame"></div>
                        <div class="overlay">
                            <div class="templatemo_service_frame"><img src="welcome/images/templatemo_serviceimg1.png" alt="templatemo_frame"></div>
                            <a href="welcome/images/service/2.jpg" data-rel="lightbox" class="fa fa-search-plus"></a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6 templatemo_service">
                    <div class="gallery-item">
                        <img src="welcome/images/service/3.jpg" alt="gallery 3">
                        <div class="templatemo_service_frame"><img src="welcome/images/templatemo_serviceimg.png" alt="templatemo_frame"></div>
                        <div class="overlay">
                            <div class="templatemo_service_frame"><img src="welcome/images/templatemo_serviceimg1.png" alt="templatemo_frame"></div>
                            <a href="welcome/images/service/3.jpg" data-rel="lightbox" class="fa fa-search-plus"></a>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 templatemo_service">
                ...
                <div class="col-sm-4">
                    <div class="templatemo_pricing_table">
                        <div class="templatemo_pricingbg">
                            <img src="welcome/images/templatemo_pricing_bg.jpg" alt="templatemo price img">
                        </div>
            ...
            <div id="templatemo_about" class="row">
                <div class="col-md-4 templatemo_work"><img src="welcome/images/templatemo_workicon.png" alt="templatemo work"></div>
                <div class="col-md-8">
            ...
            <div id="templatemo_contact" class="row templatemo_contact">
                ...
                <div class="col-md-8">
                    <div class="templatemo_contactmap">
                        ...
                        <div class="templatemo_mapcorner"><img src="welcome/images/templatemo_mapcorner.png" alt="Google Maps"></div>
                    </div>
                </div>
            </div>
            <!-- contact end -->
        ...
        <div class="templatemo_footer">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                    	Copyright &copy; 2020 <a href="#">Bio Exp</a>
                    </div>
                </div>
            </div>
        </div>
